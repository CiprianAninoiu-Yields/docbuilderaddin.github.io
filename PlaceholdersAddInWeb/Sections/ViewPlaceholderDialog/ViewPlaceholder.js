(function () {
    ...
    Office.initialize = function (reason) {
        placeholderTag = GetURLParameter('tag').replace(/%3E/g, " ").replace(/%3C/g, " ").replace(/%3/g, " ").replace(/%20/g, " ");
        description = GetURLParameter('description').replace(/%3E/g, " ").replace(/%3C/g, " ").replace(/%3/g, " ").replace(/%20/g, " ");
